hexya.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether hexya is focused or not
     *
     * @returns {boolean}
     */
    isHexyaFocused: function () {
        return this._isHexyaFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isHexyaFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isHexyaFocused);
        }
    },
    /**
